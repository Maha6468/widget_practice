...
import 'package:widget_practice/Normal_widget/provider.dart';
        ...
        children: [
          LiquidSwipe(
           ...
           // liquidController:controller,
            liquidController: context.read<PageProvider>().controller,
            //enableLoop: true,
            enableLoop: false,
            ...
            onPageChangeCallback: (index){
              context.read<PageProvider>().setPage(index);
            },
          ),
          Positioned(
            bottom: 0,
            ...
            child: Row(
              ...
              children: [
                TextButton(onPressed: (){
                  context.read<PageProvider>().skipPage(pages.length);
                },
                    child: Text("Skip")),
                ...
                TextButton(onPressed: (){
                  context.read<PageProvider>().nextPage(pages.length);
